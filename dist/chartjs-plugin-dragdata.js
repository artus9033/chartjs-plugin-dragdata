  ...
  */ const requestAnimFrame = function() {
  ...
  const getElement = (e, chartInstance, callback) => {
    ...
    if (element) {
      ...
      if (type === 'bar') {
        ...
        const newPos = calcPosition(e, chartInstance, datasetIndex, index);
  ...
  const updateData = (e, chartInstance, pluginOptions, callback) => {
    if (element) {
      ...
      if (type === 'radar' || type === 'polarArea') {
        ...
        const cursorPos = calcPosition(e, chartInstance, curDatasetIndex, curIndex);
  ...
  const ChartJSdragDataPlugin = {
    ...
    afterInit(chartInstance) {
      console.log({ chartInstance, plugins: chartInstance.config.options.plugins });
