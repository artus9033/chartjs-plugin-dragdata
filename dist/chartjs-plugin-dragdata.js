(function (global, factory) {
  ...
  var element, yAxisID, xAxisID, rAxisID, type, stacked, floatingBar, initValue, curDatasetIndex, curIndex, eventSettings;
  ...
  // TODO: extract TType from chartInstance & pass it to Options<TType>
  var getElement = function (e, chartInstance, callback) {
      ...
      if (element) {
          ...
          eventSettings = getSafe(function () { return chartInstance.config.options.plugins.tooltip.animation; });
          ...
          if (dataset.dragData === false ||
              (chartInstance.config.options.scales[xAxisID] &&
                  // TODO: extend scales & data typings in Chart.js that are used below
                  // @ts-ignore
          ...
          if (type === "bar") {
              ...
              var newPos = calcPosition(e, chartInstance, datasetIndex, index);
  ...
  var updateData = function (e, chartInstance, pluginOptions, callback) {
      if (element) {
          curDatasetIndex = element.datasetIndex;
          curIndex = element.index;
          isDragging = true;
          var dataPoint = chartInstance.data.datasets[curDatasetIndex].data[curIndex];
          if (type === "radar" || type === "polarArea") {
              dataPoint = calcRadar(e, chartInstance);
          }
          else if (stacked) {
              var cursorPos = calcPosition(e, chartInstance, curDatasetIndex, curIndex);
  ...
  function applyMagnet(chartInstance, i, j) {
      var pluginOptions = chartInstance.config.options.plugins.dragData;
      if (pluginOptions.magnet) {
          var magnet = pluginOptions.magnet;
  ...
  var dragEndCallback = function (e, chartInstance, callback) {
      curIndex = undefined;
      isDragging = false;
  ...
  var ChartJSdragDataPlugin = {
      ...
      afterInit: function (chartInstance) {
          if (chartInstance.config.options.plugins &&
              ...
              var pluginOptions_1 = chartInstance.config.options.plugins.dragData;
              select(chartInstance.canvas).call(drag()
                  .container(chartInstance.canvas)
                  .on("start", function (e) {
                  return getElement(e.sourceEvent, chartInstance, pluginOptions_1.onDragStart);
              })
                  .on("drag", function (e) {
                  return updateData(e.sourceEvent, chartInstance, pluginOptions_1, pluginOptions_1.onDrag);
              })
                  .on("end", function (e) {
                  return dragEndCallback(e.sourceEvent, chartInstance, pluginOptions_1.onDragEnd);
              }));
          }
      },
      beforeEvent: function (chart) {
          var _a, _b;
          if (isDragging) {
              (_b = (_a = chart.tooltip) === null || _a === void 0 ? void 0 : _a.update) === null || _b === void 0 ? void 0 : _b.call(_a);
              return false;
          }
      },
  };
