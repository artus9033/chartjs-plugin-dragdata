...
(async () => {
  ...
  // disabled drag line chart
  const disabledDragSettings = new Settings()
  disabledDragSettings.draggingDisabled = true
  await run('disableDragOnFirstLine',disabledDragSettings)
